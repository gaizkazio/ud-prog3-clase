...
public class EjemploUtilidadesStringParaJUnit {
	...
	/** Devuelve cualquier string sin saltos de línea
	 *  ni tabuladores (para poder exportarlo de forma tabular 
	 *  sin conflicto)
	 * @param s	String con cualquier contenido
	 * @return	Mismo string sustituyendo \t con
	 *  el carácter | y \n con el carácter #; 
	 *  Devuelve null si s es null.
	 */
	public static String quitarTabsYSaltosLinea( String s ) {
		System.out.println( "*Entrando en qtysl");
		return s.replaceAll( "\n", "#" ).replaceAll( "\t", "|" );
	}
